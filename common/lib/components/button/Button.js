...
var resolveColor = function (_a) {
    var color = _a.color, ghost = _a.ghost;
...
var StyledButton = (_a = ["\n  border: 1px solid transparent;\n  border-radius: 3px;\n  box-shadow: none;\n  cursor: pointer;\n  display: inline-flex;\n  flex-shrink: 0;\n  align-items: center;\n  ", "\n  ", "\n  transition: all 200ms ease-in-out;\n  user-select: none;\n"], _a.raw = ["\n  border: 1px solid transparent;\n  border-radius: 3px;\n  box-shadow: none;\n  cursor: pointer;\n  display: inline-flex;\n  flex-shrink: 0;\n  align-items: center;\n  ", "\n  ", "\n  transition: all 200ms ease-in-out;\n  user-select: none;\n"], styled_components_1.default(Button)(_a, function (props) { return styles_1.getFormElementDimensions(props.size); }, resolveColor));
